  ...
  <div class="container">
    ...
    <?php
      ...
      !empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
            ...
            echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="#"'.$attribut_new_tab.' rel="nofollow">Developed </a>'.__('by','zerif-lite').'<a class="zerif-copyright" href="http://www.officeji.co.in/"'.$attribut_new_tab.' rel="nofollow"> Officeji</a></div>';
